...
# ==============================================================================
"""Definition of 300 MobileNetV1-based SSD network.
...
Usage:
    with slim.arg_scope(ssd_mobilenetv1.ssd_mobilenetv1()):
        outputs, end_points = ssd_mobilenetv1.ssd_mobilenetv1(inputs)
...
def ssd_multibox_layer(inputs,
    ...
    loc_pred = slim.conv2d(net, num_loc_pred, [1, 1], activation_fn=None,
                           scope='conv_loc')
    ...
    cls_pred = slim.conv2d(net, num_cls_pred, [1, 1], activation_fn=None,
                           scope='conv_cls')
...
def ssd_losses(logits, localisations,
    ...
    with tf.name_scope(scope, 'ssd_losses'):
        ...
        print(gclasses.shape)
        print(gscores.shape)
        print(glocalisations.shape)
...
def ssd_losses_old(logits, localisations,
                   ...
                   device='/cpu:0',
                   scope=None):
    """Loss functions for training the SSD 300 MobileNetV1 network.
